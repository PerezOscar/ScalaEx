...
def reduceMeasure(num,unit):
    #Compute the number of teaspoons that the paramenters represent
    unit = unit.lower()
...
def main():
    ...
    print("1 teaspoons is %s." % reduceMeasure(59, "teaspoon"))
    print("1 tablespoons is %s." % reduceMeasure(1, "tablespoon"))
